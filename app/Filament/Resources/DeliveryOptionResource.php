...
use App\Filament\Resources\DeliveryOptionResource\RelationManagers;
...
class DeliveryOptionResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => Pages\CreateDeliveryOption::route('/create'),
            'edit' => Pages\EditDeliveryOption::route('/{record}/edit'),
        ];
    }
}
